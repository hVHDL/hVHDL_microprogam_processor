...
testi.add_source_files(ROOT / "source/hVHDL_floating_point/normalizer/normalizer_configuration/normalizer_with_2_stage_pipe_pkg.vhd")
testi.add_source_files(ROOT / "source/hVHDL_floating_point/normalizer/*.vhd")
testi.add_source_files(ROOT / "source/hVHDL_floating_point/denormalizer/denormalizer_configuration/denormalizer_with_2_stage_pipe_pkg.vhd")
