...
float.add_source_files(ROOT / "source/hVHDL_floating_point/normalizer/normalizer_configuration/normalizer_with_4_stage_pipe_pkg.vhd")
float.add_source_files(ROOT / "source/hVHDL_floating_point/normalizer/*.vhd")
float.add_source_files(ROOT / "source/hVHDL_floating_point/denormalizer/denormalizer_configuration/denormalizer_with_3_stage_pipe_pkg.vhd")
